...
const WorkspacesOverviewTable = ({
  ...
  const displayedWorkspaces = showAll
    ? workspaces
    : workspaces.slice(0, initialLimit);
        ...
        <table className="w-full table-fixed border-collapse min-w-[800px]">
          <thead>
            <tr className="border-b border-slate-200 text-left">
              <th className="w-1/5 pb-3 text-xs font-semibold uppercase text-slate-400">
                Workspace
              </th>
              <th className="w-1/5 pb-3 text-xs font-semibold uppercase text-slate-400">
                Admin
              ...
              <th className="w-1/5 pb-3 text-xs font-semibold uppercase text-slate-400 text-center">
                Action
              </th>
            </tr>
          </thead>
