      ...
      <div className="w-full max-w-[420px] bg-white rounded-3xl border border-[#d6e0ff] overflow-hidden">
        ...
        <div className="px-8 pt-10 pb-8 text-center">
          ...
          <div className="relative w-[72px] h-[72px] rounded-full bg-blue-50 border-2 border-blue-200 flex items-center justify-center text-blue-600 text-3xl font-semibold mx-auto mb-5">
            ...
            <span className="absolute bottom-0.5 right-0.5 w-3.5 h-3.5 rounded-full bg-slate-200 border-2 border-white animate-pulse" />
          </div>
          ...
          {!loading && (
            <span
              className={`inline-flex items-center gap-1.5 text-[11px] font-mono font-medium tracking-widest uppercase px-3 py-1 rounded-full mb-6 border ${statusBadge().color}`}
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${statusBadge().dot} animate-pulse`}
              />
              {statusBadge().label}
            </span>
          )}
          ...
          <p className="text-sm text-slate-500 leading-relaxed mb-7">
            {workspaceStatus === "disabled"
              ? "This workspace has been disabled by the administrator. Users will not be able to access the dashboard until it is re-enabled."
              : "Your workspace is awaiting approval from the Super Admin. We'll notify you once it's ready."}
          </p>
            ...
            <div className="flex justify-center gap-0 mb-8">
              {[
                ...
                >
                  ...
                  <div
                    className={`relative z-10 w-[22px] h-[22px] rounded-full flex items-center justify-center text-[10px] font-semibold mb-1.5
                  ...
                  <span
                    className={`text-[10px] font-mono tracking-wide whitespace-nowrap
        ...
        <div className="bg-[#f8faff] border-t border-[#e0eaff] py-3 px-8 text-center text-[11px] font-mono text-slate-400 tracking-wide">
          workspace · {workspaceStatus || "pending"} · ref #WS-
